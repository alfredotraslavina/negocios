...
class InvensControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create inven" do
    assert_difference('Inven.count') do
      post invens_url, params: { inven: { cantidad: @inven.cantidad, marca: @inven.marca, modelo: @inven.modelo, nombre_objeto: @inven.nombre_objeto, peso: @inven.peso, precio: @inven.precio } }
    end
  ...
  test "should update inven" do
    patch inven_url(@inven), params: { inven: { cantidad: @inven.cantidad, marca: @inven.marca, modelo: @inven.modelo, nombre_objeto: @inven.nombre_objeto, peso: @inven.peso, precio: @inven.precio } }
